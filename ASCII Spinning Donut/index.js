(function () {
    ...
    function startAsciiAnimation(){
        // start by calling it renderAsciiAnimation every 50ms
        window.asciiIntervalId = setInterval(renderAsciiFrame,
        50);
    }
